    ...
    <div className={`min-h-screen ${themeClasses.bg} transition-all duration-500`}>
      <div className="space-y-6 p-6">
        <div className="text-center mb-8">
          <h2 className={`text-3xl font-bold ${themeClasses.text} mb-2`}>Campaign Simulations</h2>
          <p className={`${themeClasses.textSecondary}`}>Test and optimize your strategies before going live</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {simulationTypes.map((simulation) => {
            ...
            return (
              <div
                key={simulation.id}
                className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-2xl p-6 transition-all duration-300 cursor-pointer transform hover:scale-105 ${themeClasses.shadow} ${
                  isActive
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${themeClasses.textSecondary} text-sm mb-3`}>{simulation.description}</p>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {isActive && (
                        <button
                          ...
                          className={`flex items-center px-4 py-2 bg-${simulation.color}-500 text-white rounded-xl hover:bg-${simulation.color}-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed`}
                        >
